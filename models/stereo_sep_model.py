...
class StereoNetSep(nn.Module):
    ...
    def forward(self, left_img, right_img):
        ...
        lf = self.feature_extractor_left(left_img)
        rf = self.feature_extractor_right(right_img)

        # What exactly here makes two separate network paths and not one unified one?
        # This is unclear from the code vs the model diagram given.
